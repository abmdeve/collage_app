...
export const TEMPLATES: Template[] = [
  {
    ...
    placeholders: [{ x: 50, y: 100, width: 200, height: 300 }],
  },
  {
    id: "template-2",
    name: "Spring Story 2",
...
export const BIRTHDAY_TEMPLATES: Template[] = [
  {
    ...
    placeholders: [{ x: 400, y: 600, width: 300, height: 400 }], // Estimated placeholder area
  },
  {
    ...
    placeholders: [{ x: 400, y: 600, width: 300, height: 400 }],
  },
  {
    id: "birthday-template-3",
  ...
  {
    id: "birthday-template-4",
    name: "Birthday Card 4",
    image:
      "https://via.placeholder.com/1135x1702.png?text=Birthday+Card+4+Floral",
    placeholders: [{ x: 400, y: 600, width: 300, height: 400 }],
  },
  {
    id: "birthday-template-5",
    name: "Birthday Card 5",
    image:
      "https://via.placeholder.com/1135x1702.png?text=Birthday+Card+5+5Stars",
    placeholders: [{ x: 400, y: 600, width: 300, height: 400 }],
  },
  {
    id: "birthday-template-6",
    name: "Birthday Card 6",
    image:
      "https://via.placeholder.com/1135x1702.png?text=Birthday+Card+6+Party",
    placeholders: [{ x: 400, y: 600, width: 300, height: 400 }],
  },
];

export const DESIGN_OPTIONS: DesignOptions[] = [
